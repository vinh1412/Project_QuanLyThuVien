...
import views.components.Theme.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String headerName = "H2TD";
...
//                + "thumb:$Menu.ScrollBar.thumb");
    ...
    private void createMenu() {
        ...
        for (int i = 0; i < menuItems.length; i++) {
            ...
            if (menuName.startsWith("~") && menuName.endsWith("~")) {
                ...
                MenuItem menuItem = new MenuItem(this, menuItems[i], index++, events, isNVQL);
    ...
    protected void runEvent(int index, int subIndex) throws RemoteException, MalformedURLException, NotBoundException {
