...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("src/main/java/Img/svgIcon/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("src/main/java/Img/svgIcon/dark.svg"));
