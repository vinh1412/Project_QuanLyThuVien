...
public class panel_QuanLyHoaDon extends javax.swing.JPanel {
     ...
     */
    public panel_QuanLyHoaDon() throws SQLException {
    ...
    private void renderData() throws SQLException {
        ...
        for (HoaDon i : dsHD) {
            String tenNV = nhanVien_Dao.timNhanVienByMa(i.getNhanVien().getMaNhanVien()).getTenNhanVien();
    ...
    private void timHoaDonByMa() throws SQLException {
    ...
    private void locHoaDon() throws SQLException {
