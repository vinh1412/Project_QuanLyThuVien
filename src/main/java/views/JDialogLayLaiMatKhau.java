...
public class JDialogLayLaiMatKhau extends javax.swing.JDialog {
     ...
     */
    public JDialogLayLaiMatKhau(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private boolean validData() {
        ...
        TaiKhoan tk = tk_Dao.getTaiKhoanByTen(tenTK);
        if (tk == null) {
...
String tenTK = txt_tenTaiKhoan.getText();
    ...
    private void btn_xacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_xacNhanActionPerformed
        // TODO add your handling code here:
        if (validData()) {
            if (tk_Dao.updateMatKhau(txt_tenTaiKhoan.getText(), txT_matKhauMoi.getText())) {
                dispose();
            }
            else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogLayLaiMatKhau dialog = new JDialogLayLaiMatKhau(new javax.swing.JFrame(), true);
